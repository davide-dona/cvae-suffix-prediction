...
class GenericDataset(Dataset):
    ...
    def __init__(self, split_dataset: pd.DataFrame, dataset_info: DatasetInfo, encoding: Encoding):
        ...
        self._traces = _group_traces(split_dataset, dataset_info.condition_features, max_content_len, encoding)
...
def _group_traces(
    split_dataset: pd.DataFrame, condition_features: list[str], max_content_len: int, encoding: Encoding
) -> list[_Trace]:
