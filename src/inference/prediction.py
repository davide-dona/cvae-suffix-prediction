...
class PredictionRow:
    ...
    The model writes activities and time deltas only, so there is no `predicted_resources` to
    put beside `true_resources`. The ground-truth resources stay: they cost nothing to carry
